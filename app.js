...
const selectedName = 'propertyName';
const selectedNameString = userProfile[selectedName];
console.log(selectedNameString); */

/* const userProfile = 'propertyName';
const propertyNameString = {
    [userProfile]: 'Anna',
}

console.log(propertyNameString); */
...
// Your code here
function whiteCat(noun = 'cat', adjective = 'white') {
